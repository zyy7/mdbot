...
Sc? Beli Aj Broh Murah Kok:v`
            ...
            break
             case 'tes': {
                m.reply('On Kak,Silahkan Bot Nya Dipakai Tapi Jan Spam Command Bot nya Yh kak 😉')
            }
            break
            case 'chat': {
                    ...
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                ...
                                quickReplyButton: {
                                    displayText: 'ℒ𝒾𝓈𝓉 ℳℯ𝓃𝓊',
                                    id: 'command'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: '𝒜𝓁𝓁 ℳℯ𝓃𝓊',
                                    id: 'allmenu'
                                }  
                            }, {
                                quickReplyButton: {
